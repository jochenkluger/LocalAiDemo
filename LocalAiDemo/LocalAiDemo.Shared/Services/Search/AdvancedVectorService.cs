...
namespace LocalAiDemo.Shared.Services.Search
{
    ...
    public class AdvancedVectorService : IAdvancedVectorService
    {
            ...
            try
            {
                ...
                for (int i = 0; i < chatsWithVectors.Count && clusters.Count < maxClusters; i++)
                {
                    ...
                    var cluster = new ChatCluster
                    {
                        Id = clusters.Count + 1,
                        SeedChat = seedChat,
                        Chats = new List<Models.Chat> { seedChat }
                    };
        ...
        public async Task RebuildVectorIndicesAsync()
        {
            ...
            try
            {
                // This is a placeholder for rebuilding vector indices In a real implementation, you would:
        ...
        public async Task<int> CleanupOrphanedVectorEntriesAsync()
        {
            ...
            try
            {
                // This is a placeholder for the actual cleanup implementation In a real
                // implementation, you would need direct SQL access to:
        ...
        // Helper methods
        private float CalculateTextRelevance(Models.Chat chat, string query)
        {
            float relevance = 0f;
        ...
        private float CalculateClusterAverageSimilarity(List<Models.Chat> chats)
        {
    ...
    {
        public Models.Chat Chat { get; set; } = new();
    ...
    public class ChatCluster
    {
        ...
        public Models.Chat SeedChat { get; set; } = new();
