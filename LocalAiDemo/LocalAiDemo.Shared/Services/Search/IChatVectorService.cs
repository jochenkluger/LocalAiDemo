...
/// <summary>
/// Main facade service for all chat vectorization operations Combines ChatVectorizationService and
/// AdvancedVectorService for easy access
/// </summary>
public interface IChatVectorService
{
    ...
    // Search operations
    Task<List<Models.Chat>> FindSimilarChatsAsync(string query, int limit = 5);
