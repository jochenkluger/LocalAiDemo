...
{
    /// <summary>
    /// TTS-Service, der Piper für hochqualitative lokale Text-to-Speech verwendet Piper ist die
    /// TTS-Engine von Home Assistant mit neuronalen Netzwerken
    /// </summary>
        ...
        private bool IsInPath(string executable)
        {
            try
            {
                ...
                if (testProcess != null)
                {
                    ...
                    var available =
                        testProcess.ExitCode == 0 || testProcess.ExitCode == 1; // Help zeigt oft exit code 1
                    testProcess.Dispose();
                    return available;
                }
            }
            ...
            try
            {
                ...
                if (!Directory.Exists(_modelsPath))
                {
                    ...
                    Logger.LogInformation(
                        "Keine Piper-Modelle gefunden. Deutsche Modelle können heruntergeladen werden von:");
