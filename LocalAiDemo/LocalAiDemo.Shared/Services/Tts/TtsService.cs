    ...
    public class TtsProviderFactory : ITtsProviderFactory
    {
            ...
            ILogger<TtsProviderFactory> logger)
        {
            ...
            _logger.LogInformation(
                "TTS Provider Factory initialisiert mit {Count} Providern. Aktueller Provider: {Provider}",
        ...
        public ITtsService GetTtsService()
        {
            ...
            _logger.LogWarning(
                "Der Provider {Provider} wurde nicht gefunden. Verwende den ersten verfügbaren Provider.",
                _currentProvider);
